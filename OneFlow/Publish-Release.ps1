...
$releaseBranch = "$officialRemoteName/release/$tagName"
...
Write-Information "Switching to release branch (from official repo) [$releaseBranch]"
Invoke-External git switch -c $releasebranch $releasebranch
