...
#>
    ...
    # NOTE: This is the version of LLVM itself and not the version of the library
    # or components generated by this build. That is, this is the version for a
    # ***DEPENDENCY*** as opposed to the version of the anything built.
